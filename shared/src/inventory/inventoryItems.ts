...
export const INVENTORY_ITEMS: InventoryItemDefinition[] = [
  ...
  { id: 'big_healing_potion', name: 'Big Healing Potion', description: 'Strong medicine for dangerous fights.', category: 'potion', sellValue: 24 },
  { id: 'herb_tea', name: 'Herb Tea', description: 'Restores health and stamina.', category: 'potion', sellValue: 10 },
  ...
  { id: 'rare_oasis_fish', name: 'Rare Oasis Fish', description: 'A valuable fish from hidden reeds.', category: 'fish', rarity: 'rare', sellValue: 14 },
  { id: 'grilled_fish', name: 'Grilled Fish', description: 'Cooked food from oasis fish.', category: 'food', sellValue: 8 },
  { id: 'cooked_meat', name: 'Cooked Meat', description: 'Campfire food from hunted game.', category: 'food', sellValue: 8 },
  { id: 'travel_rations', name: 'Travel Rations', description: 'Preserved food for long paths.', category: 'food', sellValue: 9 },
  ...
  { id: 'recipe_arrows', name: 'Arrow Recipe', description: 'Teaches simple arrow fletching.', category: 'quest' },
